...
Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic> conductivity_nonlinear<U, DIM>::Gamma3shgContract_RA(){
...
template <typename U, unsigned DIM>
Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic> conductivity_nonlinear<U, DIM>::Gamma3shgContract_RR(){
  // Calculate the first of the three three-velocity terms.
  // this is the term with two Green's functions that depend on the 
  // frequency, making it more difficult to calculate.
...
#pragma omp for schedule(static, 1) nowait
  for(int i = 0; i < N_threads; i++){
    ...
    Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Gamma3Aligned;
    Gamma3Aligned = Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>::Zero(N1*local_NumMoments, N2);
    ...
    // Matrix of Green's functions
    Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic> Green2R, GreenR;
    Green2R = Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>::Zero(N_energies, local_NumMoments);
    GreenR  = Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>::Zero(N_energies, N1);
...
template <typename U, unsigned DIM>
Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic> conductivity_nonlinear<U, DIM>::Gamma3shgContract_AA(){
  // Calculate the first of the three three-velocity terms.
  // this is the term with two Green's functions that depend on the 
  // frequency, making it more difficult to calculate.
...
#pragma omp for schedule(static, 1) nowait
  for(int i = 0; i < N_threads; i++){
    ...
    Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Gamma3Aligned;
    Gamma3Aligned = Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>::Zero(N2*local_NumMoments, N0);
    ...
    // Matrix of Green's functions
    Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic> GreenA, Green2A;
    Green2A = Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>::Zero(N_energies, N2);
    GreenA  = Eigen::Matrix<std::complex<U>, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>::Zero(N_energies, local_NumMoments);
